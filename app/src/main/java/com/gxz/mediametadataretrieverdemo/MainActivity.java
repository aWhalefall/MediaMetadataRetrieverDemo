...
public class MainActivity extends AppCompatActivity {
    private  String path = Environment.getExternalStorageState() + "/VID_20200529_092856.mp4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        path = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES), "video").getAbsolutePath()+"/VID_20200529_092856.mp4";
